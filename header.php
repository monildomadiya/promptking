...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Poppins', sans-serif; -webkit-tap-highlight-color: transparent; }
        ...
        #cardContainer, #skeletonContainer { column-count: 1; column-gap: 25px; width: 100%; padding-top: 10px; }
        @media (min-width: 768px) { #cardContainer, #skeletonContainer { column-count: 2; } } 
        @media (min-width: 1024px) { #cardContainer, #skeletonContainer { column-count: 3; } } 
